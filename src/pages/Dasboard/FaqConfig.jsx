  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col gap-5">
              ...
              onClick={() => {
                axios
                  .post(
                    ...
                    { name: "how_to_transaction", value: text1 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "how_to_open_account", value: text2 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
        ...
        <div className="flex flex-col gap-2">
          <p className="text-2xl text-gray-900 font-bold">
            What are the rules or condition for opening an account
          </p>
          <div className="border border-gray-700  ">
            <JoditEditor
              ref={editor}
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "condition_of_opening_acc", value: text3 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "fb_group_links", value: text4 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "how_to_be_agent", value: text5 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
        ...
        <div className="flex flex-col gap-2">
          <p className="text-2xl text-gray-900 font-bold">
            How to do complain aganist agent
          </p>
          <div className="border border-gray-700  ">
            <JoditEditor
              ref={editor}
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "how_to_do_complain", value: text6 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
