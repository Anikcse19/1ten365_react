              ...
              onClick={() => {
                axios
                  .post(
                    ...
                    { name: "user_alert_for_agent", value: text1 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "user_alert_for_super_agent", value: text2 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "user_alert_for_sub_admin", value: text3 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            <button
              onClick={() => {
                axios
                  .post(
                    `${base_url}/config/create`,
                    { name: "user_alert_for_admin", value: text4 },
                    {
                      headers: {
                        Accept: "application/json",
                        Authorization: `Bearer ${token}`,
