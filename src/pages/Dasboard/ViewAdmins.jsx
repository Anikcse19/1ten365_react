      ...
      <div className="">
        <div className=" mx-auto md:px-4   md:p-5">
          ...
          <div className="flex items-center gap-3 mt-5">
            ...
            <select className="px-5 py-2 rounded-md outline-none border border-gray-800" onChange={(e)=>{
              ...
              <option  value="all">All</option>
                {
                  types.map((type,i)=>(
                    <option className="px-5 py-2 rounded-md" value={type} key={i}>{type}</option>
                  ))
                }
            </select>
            <span onClick={()=>{   
              if(selectedtype=='all'){
                ...
                const filteredData=datas?.filter(data=>data?.profile?.type==selectedtype)             
                setSearchedDatas(filteredData)
                
            }} className="bg-gray-400 hover:bg-gray-500 text-white font-bold cursor-pointer px-12 py-2 rounded-md">Search</span>
          </div>
           {/* filter end */}
