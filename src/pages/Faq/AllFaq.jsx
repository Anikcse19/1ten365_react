  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-center w-[80%] mx-auto mb-20">
          ...
          <div className="bg-white w-full min-h-screen">
            <div className="">
              <div className="">
                ...
                <div
                  className="my-10"
                  dangerouslySetInnerHTML={{ __html: configDatas[4]?.value }}
                />
                {/* online pay */}

                <div className="w-[90%] mx-auto absolute bottom-2 px-2  ">
                  <button
        ...
        <div className="border border-gray-900 px-4 py-2 relative w-fit">
          <div className="bg-white w-full min-h-screen">
            <div className="">
              <div className="">
                <p className="text-2xl md:text-xl font-bold ">
